        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CityId = table.Column<int>(type: "int", nullable: false),
                    CompanyKey = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecruiterCompanyCompanyId = table.Column<int>(type: "int", nullable: true),
                    RecruiterCompanyRecruiterId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruiterCompanies", x => new { x.RecruiterId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_RecruiterCompanies_Companies_CompanyId",
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.RecruiterCompanyRecruiterId, x.RecruiterCompanyCompanyId },
                        principalTable: "RecruiterCompanies",
                        principalColumns: new[] { "RecruiterId", "CompanyId" });
                    table.ForeignKey(
                        name: "FK_RecruiterCompanies_Recruiters_RecruiterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruiterCompanies_CompanyId",
